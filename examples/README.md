...
## Examples with Cavium HSM
Not: The partition pin must be in the format username:password.
...
$ python rsagen-test.py -p11 /home/liquidsec_bin/lib/libliquidsec_pkcs11.so -slot 1 -pin crypto_user:12345678 -mech RSA_X9_31_KEY_PAIR_GEN -size 2048 -size 2048 -ops 1

### Timed tests for EC generation (1 operation)
$ python ecgen-test.py -p11 /home/liquidsec_bin/lib/libliquidsec_pkcs11.so -slot 1 -pin crypto_user:12345678 -curve P256 -ops 1
