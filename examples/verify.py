...
def __main():
    ...
    parser = argparse.ArgumentParser("verify", description="Verify with cryptographic key (RSA/EC private key).")
    ...
    parser.add_argument("-sig", dest="sig", type=str, required=True,
                        help="Binary signature as a hex encoded string.")
