...
from pihsm.hsmenums import HsmAsymKeyType
from pihsm.hsmenums import HsmAttribute
from pihsm.hsmenums import HsmMech
from pihsm.hsmenums import HsmSession
from pihsm.hsmenums import HsmSymKeyGen
from pihsm.hsmenums import HsmSymKeyType
from pihsm.hsmenums import HsmUser
...
class HsmClient:
    ...
    the library has been tested with the Utimaco HSM Simulator
    and the SoftHSM PKCS#11 shared library.

    Other HSMs that properly implement the PKCS#11 API should work
    but have not been tested with the library.  Vendor
    specific functionality is not supported by this library.

    The full path to the PKCS#11 shared library should be passed
    in the pkcs11_lib argument.  If not value is provided the
    default path /usr/lib/libpihsm.so will be used.  A symbolic link
    can be created on the host system to point /usr/lib/libpihsm.so
    to the appropriate PKCS#11 HSM shared library.
    ...
    open_session() and login() methods respectively.
        ...
        Args:
            ...
            pkcs11_lib:             full path to the PKCS#11 shared
                                    library file
                                    (optional)
                                    (default is '/usr/lib/libpihsm.so')

     Below are example commands that can be used to establish soft-links to the
     HSM PKCS#11 vendor specific shared libraries if a path_to_pkcs11_lib
     argument is not provided.

     Utimaco Simulator: sudo ln -s /usr/lib/libcs_pkcs11_R2.so /usr/lib/libpihsm.so
     SafeNet Luna SA-5: sudo ln -s /usr/lib/libCryptoki2_64.so /usr/lib/libpihsm.so
     SoftHSM: sudo ln -s /usr/lib64/pkcs11/libsofthsm2.so /usr/lib/libpihsm.so

    """
    
    def __init__(self, slot=0, pin=None, pkcs11_lib='/usr/lib/libpihsm.so'):
    ...
    def __init_libhsm(self):
        ...
        self.__libhsm.get_lib_version.argtypes = [c_char_p, c_int, c_char_p, c_int]
        self.__libhsm.connect.argtypes = [c_char_p, c_int, c_char_p, c_int]
        self.__libhsm.disconnect.argtypes = [c_char_p, c_int]
        self.__libhsm.initialize.argtypes = [c_char_p, c_int]
        self.__libhsm.finalize.argtypes = [c_char_p, c_int]
        self.__libhsm.open_session.argtypes = [c_char_p, c_int, c_int, c_int, POINTER(c_int)]
        self.__libhsm.close_session.argtypes = [c_char_p, c_int, c_int]
        self.__libhsm.close_all_sessions.argtypes = [c_char_p, c_int, c_int]
        self.__libhsm.login.argtypes = [c_char_p, c_int, c_int, c_int, c_char_p, c_int]
        self.__libhsm.logout.argtypes = [c_char_p, c_int, c_int]
        self.__libhsm.set_pin.argtypes = [c_char_p, c_int, c_char_p, c_int, c_char_p, c_int]
        self.__libhsm.find_objects.argtypes = [c_char_p, c_int, c_int, POINTER(c_int)]
        self.__libhsm.get_object_handle.argtypes = [c_char_p, c_int, c_int, c_char_p, c_int, POINTER(c_int)]
        self.__libhsm.sign.argtypes = [c_char_p, c_int, c_int, c_char_p, c_int, c_int, c_int, c_int, c_char_p,
                                       POINTER(c_int)]
        self.__libhsm.verify.argtypes = [c_char_p, c_int, c_int, c_char_p, c_int, c_int, c_int, c_int, c_char_p, c_int]
        self.__libhsm.encrypt.argtypes = [c_char_p, c_int, c_int, c_char_p, c_int, c_int, c_int, c_char_p, c_int,
                                          c_char_p, POINTER(c_int)]
        self.__libhsm.decrypt.argtypes = [c_char_p, c_int, c_int, c_char_p, c_int, c_int, c_int, c_char_p, c_int,
                                          c_char_p, POINTER(c_int)]
        self.__libhsm.digest.argtypes = [c_char_p, c_int, c_int, c_char_p, c_int, c_int, c_char_p, POINTER(c_int)]
        self.__libhsm.get_slot_count.argtypes = [c_char_p, c_int, POINTER(c_int)]
        self.__libhsm.get_token_count.argtypes = [c_char_p, c_int, POINTER(c_int)]
        self.__libhsm.get_slot_info.argtypes = [c_char_p, c_int, c_char_p, POINTER(c_int), POINTER(c_int)]
        self.__libhsm.get_attribute_value.argtypes = [c_char_p, c_int, c_int, c_int, c_int, c_char_p, POINTER(c_int)]
        self.__libhsm.seed_random.argtypes = [c_char_p, c_int, c_int, c_char_p, c_int]
        self.__libhsm.unwrap_private_key.argtypes = [c_char_p, c_int, c_int, c_int, c_char_p, c_int, c_int, c_char_p,
                                                     c_int, c_char_p, c_int, c_int, c_int, c_int, c_int, c_int, c_int,
                                                     c_int, c_int, c_int, c_int, POINTER(c_int)]
        self.__libhsm.create_rsa_key_pair.argtypes = [c_char_p, c_int, c_int, c_int, c_char_p, c_int, c_char_p, c_int,
                                                      c_char_p, c_int, c_int, c_int, c_int, c_int, c_int, c_int, c_int,
                                                      c_int, c_int, c_int, c_int, c_int, POINTER(c_int), POINTER(c_int)]
        self.__libhsm.create_ec_key_pair.argtypes = [c_char_p, c_int, c_int, c_char_p, c_int, c_char_p, c_int, c_char_p,
                                                     c_int, c_int, c_int, c_int, c_int, c_int, c_int, c_int, c_int,
                                                     c_int, c_int, c_int, c_int, POINTER(c_int), POINTER(c_int)]
        self.__libhsm.create_secret_key.argtypes = [c_char_p, c_int, c_int, c_char_p, c_int, c_int, c_int, c_int, c_int,
                                                    c_int, c_int, c_int, c_int, c_int, c_int, c_int, c_int, c_int,
                                                    c_int, POINTER(c_int)]
        self.__libhsm.set_attribute_value.argtypes = [c_char_p, c_int, c_int, c_int, c_int, c_char_p, c_int]
        self.__libhsm.generate_random.argtypes = [c_char_p, c_int, c_int, c_char_p, c_int]
        self.__libhsm.destroy_object.argtypes = [c_char_p, c_int, c_int, c_int]
        self.__libhsm.import_data_object.argtypes = [c_char_p, c_int, c_int, c_char_p, c_char_p, c_int, c_int, c_int,
                                                     POINTER(c_int)]
    ...
    def close_all_sessions(self, slot):
        ...
        if not isinstance(slot, int):
            raise HsmError("slot must be of type int")
        if slot <= 0:
            raise HsmError("invalid slot_id")
    ...
    def get_attribute_value(self,
        ...
        Returns:
            Attribute data as either text or binary string value.
        """
    ...
    def find_objects(self):
        ...
        array_ptr = (c_int * self.__findObjectsArraySize)()
        array_ptr_len = c_int(self.__findObjectsArraySize)
    ...
    def get_slot_info(self):
        ...
        buf_len_ptr = c_int(len(buf))
        token_count_ptr = c_int()
        # make the call
    ...
    def sign(self,
             handle,
             data,
             mechanism=HsmMech.SHA1_RSA_PKCS,
             pss_salt_length=0):
        """
        ...
        Args:
            ...
            mechanism:      the cryptographic signing algorithm to use
                            (default is SHA1_RSA_PKCS)
        ...
        if not isinstance(mechanism, HsmMech):
            raise HsmError("mechanism must be of type HsmMech")
    ...
    def verify(self,
        ...
        Data and signature variables should be supplied as binary strings
    ...
    def encrypt(self,
        ...
        Args:
            ...
            mechanism:      the cryptographic encryption algorithm to use
                            (default is AES_CBC_PAD)
    ...
    def decrypt(self,
        ...
        Args:
            ...
            mechanism:      the cryptographic decryption algorithm to use
                            (default is AES_CBC_PAD)
    ...
    def digest(self,
        ...
        Args:
            ...
            mechanism:      the cryptographic digest algorithm to use
                            (default is SHA256)
    ...
    def unwrap_private_key(self,
        ...
        Args:
            ...
            unwrap:                 set to True if the key is allowed to be
                                    used in un-wrapping operations
    ...
    def create_rsa_key_pair(self,
        ...
        Args:
            ...
            derive:               set to True if the private key is allowed
                                  to be used to derive other keys
        ...
        self.__validate_session()
        msg = create_string_buffer(self.__messageBufferSize)
        pub_key_bytes = str_to_bytes(public_key_label)
        pvt_key_bytes = str_to_bytes(private_key_label)
        h_pub_key_ptr = c_int()
        h_pvt_key_ptr = c_int()
    ...
    def set_attribute_value(self,
        ...
        Args:
            ...
            attribute_value:     attribute value as a binary string
        """
    ...
    def import_data_object(self,
        ...
        Args:
            ...
            data:                 data object value binary string
        ...
        if not isinstance(label, str):
            raise HsmError("label must be of type str")
        if len(label) == 0:
            raise HsmError("label must have a value")
        if not isinstance(data, bytes):
            raise HsmError("data must be of type HsmAttribute")
        if len(data) == 0:
            raise HsmError("data must have a value")
        if not isinstance(token, bool):
            raise HsmError("token must be of type bool")
        if not isinstance(overwrite, bool):
            raise HsmError("overwrite must be of type bool")
    ...
    def import_rsa_public_key(self,
        ...
        Args:
            ...
            modulus:              public modulus (binary string)

            exponent:             public exponent (binary string)
    ...
    def import_secret_key(self,
        ...
        if self.__sessionKeyHandle == 0:
            self.__sessionKeyHandle = self.create_secret_key(self.__sessionKeyLabel,
                                                             self.__sessionKeyType,
                                                             self.__sessionKeySizeInBits,
                                                             token=False)
        ...
        key_data = self.encrypt(self.__sessionKeyHandle,
                                clear_key_data,
                                self.__sessionKeyMech,
                                self.__sessionKeyIv)

        # unwrap the encrypted symmetric key onto the HSM
        h_key = self.unwrap_secret_key(self.__sessionKeyHandle,
                                       self.__sessionKeyMech,
                                       self.__sessionKeyIv,
                                       key_label,
                                       key_data,
    ...
    def wrap_key(self,
        ...
        Args:
            ...
            wrap_key_mech:          wrapping key mechanism (HsmMech)

            wrap_key_iv:            wrapping key initialization vector

        Returns:
            Wrapped key data as binary string.
        ...
        if not isinstance(wrap_key_mech, HsmMech):
            raise HsmError("wrap_key_mech must be of type HsmMech")
        if not isinstance(wrap_key_iv, bytes):
            raise HsmError("wrap_key_iv must be of type bytes")
        self.__validate_session()
        msg = create_string_buffer(self.__messageBufferSize)
